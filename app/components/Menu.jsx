...
export default function Menu() {
    ...
    return (
        <div className="w-full" ref={menuContainer}>
            {/* nav */}
            <div className="fixed top-0 w-full p-6 md:p-8 flex justify-between items-center bg-gray-100 bg-opacity-90 backdrop-blur-md md:backdrop-blur-0 md:bg-transparent z-[2]">
